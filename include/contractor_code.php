...
//INSERTA LOS DATOS DEL TENANT'S CONTACT
		...
		if(intval($_POST['company_tenant']) > 0){
			...
			$consulta_tenant ="INSERT INTO tenants_contact (company,contact_name,contact_number,contact_email,id_request,type) VALUES('".$company_tenant."','".$contact_name_tenant."','".$contact_number_tenant."','".$contact_email_tenant."','".$last_id."','".$type."') ";	
		...
		if(intval($_POST['company_property']) > 0){
			...
			$consulta_property ="INSERT INTO property_managers (company,contact_name,contact_number,contact_email,id_request,type) VALUES('".$company_property."','".$contact_name_property."','".$contact_number_property."','".$contact_email_property."','".$last_id."','".$type."') ";	
