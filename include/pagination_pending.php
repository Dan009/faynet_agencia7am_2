...
// ESTO CONSIGUE LA CANTIDAD DE RESULTADOS
	$sql = "SELECT general_information.id as general_id, general_information.city,general_information.state,general_information.date_request_sent,general_information.street_number,general_information.customer_name,general_information.time_code, general_information.company, general_information.service_number, REQUEST.id_request,REQUEST.tipo, REQUEST.estado, REQUEST.id, REQUEST.estatus_job FROM REQUEST INNER JOIN general_information ON REQUEST.id_request = general_information.time_code AND estado='1' AND estatus_job < '2' $limite"; 
