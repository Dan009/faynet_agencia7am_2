...
<!-- INSIDE PLAN-->
		...
		<?php } ?> <!-- TERMINA INSIDE PLAN -->
			<?php 
				...
				$consulta_cable_insta = "SELECT * from cable_installation_contractor WHERE id_request='".$fila_inside['id']."'";

				$resultado_cable_insta = mysqli_query($conexion,$consulta_cable_insta);

				$fila_cable_insta = mysqli_fetch_array($resultado_cable_insta);
		  ...
		  <div class="name"><strong>company name</strong></div>
			...
			<?php 
				...
				//var_dump($fila_cable_insta);

				$consulta="SELECT * FROM usuarios WHERE id='".$fila_cable_insta['company']."' ";
				$resultado= mysqli_query($conexion,$consulta);
		    ...
		    <div class="name"><strong>Contact name</strong></div>
		   	<div class="description"> <?php echo $fila_cable_insta['contact_name']; ?> </div>
			
		    <div class="name"><strong>contact</strong></div>
		   	<div class="description"> <?php echo $fila_cable_insta['contact_number']; ?>  </div>
			
		    <div class="name"><strong>contact email</strong></div>
		   	<div class="description"> <?php echo $fila_cable_insta['contact_email']; ?>  </div>
		    
			    <?php 

					$consulta_tenant = "SELECT * from tenants_contact WHERE id_request='".$fila_inside['id']."'";

					$resultado_tenant = mysqli_query($conexion,$consulta_tenant);

					$fila_tenat = mysqli_fetch_array($resultado_tenant);
		  ...
		  <div class="name"><strong>company name</strong></div>
			...
			<?php 
				...
				$consulta="SELECT * FROM usuarios WHERE id='".$fila_tenat['company']."' ";
				$resultado= mysqli_query($conexion,$consulta);
				$fila_company_inside= mysqli_fetch_array($resultado);
				echo $fila_company_inside['nombre']." ".$fila_company_inside['apellido'];
			?> 	
		    ...
		    <div class="name"><strong>Contact name</strong></div>
		   	<div class="description"> <?php echo $fila_tenat['contact_name']; ?> </div>
			
		    <div class="name"><strong>contact</strong></div>
		   	<div class="description"> <?php echo $fila_tenat['contact_number']; ?>  </div>
			
		    <div class="name"><strong>contact email</strong></div>
		   	<div class="description"> <?php echo $fila_tenat['contact_email']; ?>  </div>

		    	 <?php 

					$consulta_property = "SELECT * from tenants_contact WHERE id_request='".$fila_inside['id']."'";
		  ...
		  <div class="name"><strong>company name</strong></div>
		   	<div class="description">
			<?php 
				$consulta="SELECT * FROM usuarios WHERE id='".$fila_property['company']."' ";
				$resultado= mysqli_query($conexion,$consulta);
				$fila_company_inside= mysqli_fetch_array($resultado);
				echo $fila_company_inside['nombre']." ".$fila_company_inside['apellido'];
			?> 	
		    ...
		    <div class="name"><strong>Contact name</strong></div>
		   	<div class="description"> <?php echo $fila_property['contact_name']; ?> </div>
			
		    <div class="name"><strong>contact</strong></div>
		   	<div class="description"> <?php echo $fila_property['contact_number']; ?>  </div>
			
		    <div class="name"><strong>contact email</strong></div>
		   	<div class="description"> <?php echo $fila_property['contact_email']; ?>  </div>
