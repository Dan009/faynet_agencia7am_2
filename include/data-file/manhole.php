	...
	include("save_img.php");	
		...
		//// OUTSIDE MANHOLE
			if( $_POST['si_outside_proposed_manhole'] =="si" and $_POST['task_request_number_outside_manhole'] !==""){
					$consulta_request="INSERT INTO request (id_request,tipo,fecha,estado, contratista_id, usuario_id) VALUES('".$_SESSION['time_code']."','outsite_utility_manhole_plan','".$fecha."','1','2','".$_SESSION['id']."') ";
					$resultado_request= mysqli_query($conexion,$consulta_request);	
					$last_id_request=mysqli_insert_id($conexion);

				$consulta_outside_manhole="INSERT INTO outsite_utility_manhole_plan (service_number,id_request  ,task_request_number_outsite_manhole,date_task_request_outsite_manhole,expected_date_outsite_manhole,company_outsite_manhole,contact_outsite_manhole,breakout_application_task_manhole ) VALUES('".mysqli_real_escape_string($conexion,htmlspecialchars($_POST['service_number']))."','".$last_id_request."','".$task_request_number_outside_manhole."','".$date_task_requested_outside_manhole."','".$expected_return_date_outside_manhole."','".$company_outside_manhole."','".$contact_outside_manhole."','".$si_breakout_manhole."' ) ";
		...
		//// UNDERGROUND OUTSIDE MANHOLE
			if( $_POST['si_outside_proposed_manhole'] =="si" and $_POST['task_request_number_outside_manhole'] !=="" and $_POST['si_underground_task_manhole']=="si"){
				$consulta_request="INSERT INTO request (id_request,tipo,fecha,estado, contratista_id, usuario_id) VALUES('".$_SESSION['time_code']."','underground_outsite_manhole_plan','".$fecha."','1','2','".$_SESSION['id']."') ";
					$resultado_request= mysqli_query($conexion,$consulta_request);	
					$last_id_request=mysqli_insert_id($conexion);

				$consulta_underground_outside_manhole="INSERT INTO underground_outsite_manhole_plan(service_number,id_request  ,company_underground_manhole,contact_underground_manhole,cust_cable_count_underground_manhole,cust_tie_loc_underground_manhole,scope_work_underground_manhole ) VALUES('".mysqli_real_escape_string($conexion,htmlspecialchars($_POST['service_number']))."','".$last_id_request."','".$company_underground_manhole."','".$contact_underground_manhole."','".$cust_cable_count_manhole."','".$cust_tie_loc_to_net_manhole."','".$textarea_scope_underground_manhole."' )";
		...
		//// AERIAL OUTSIDE MANHOLE
			if( $_POST['si_outside_proposed_manhole'] =="si" and $_POST['task_request_number_outside_manhole'] !=="" and $_POST['si_aerial_task_manhole']=="si"){
					$consulta_request="INSERT INTO request (id_request,tipo,fecha,estado, contratista_id, usuario_id) VALUES('".$_SESSION['time_code']."','aerial_outsite_manhole_plan','".$fecha."','1','2','".$_SESSION['id']."') ";
					$resultado_request= mysqli_query($conexion,$consulta_request);	
					$last_id_request=mysqli_insert_id($conexion);
					$consulta_aerial_outside_manhole="INSERT INTO aerial_outsite_manhole_plan(service_number,id_request  ,company_aerial_manhole,contact_aerial_manhole,cust_cable_count_aerial_manhole,cust_tie_loc_aerial_manhole,scope_work_aerial_manhole ) VALUES('".mysqli_real_escape_string($conexion,htmlspecialchars($_POST['service_number']))."','".$last_id_request."','".$company_aerial_manhole."','".$contact_aerial_manhole."','".$cust_cable_count_aerial_manhole."','".$cust_tie_loc_to_net_aerial_manhole."','".$textarea_scope_aerial_manhole."'  )  ";
