	...
	///////////////////////////////////////////////////////////////////////////////////////		
		...
		////// RAILROAD CIVIL
			if($_POST['si_railroad_plans_civil'] =="si" and $_POST['task_request_number_railroad_plans_civil']!==""){
				$consulta_request="INSERT INTO request (id_request,tipo,fecha,estado, contratista_id, usuario_id) VALUES('".$_SESSION['time_code']."','railroad_request_civil_plans','".$fecha."','1','2','".$_SESSION['id']."') ";
				$resultado_request= mysqli_query($conexion,$consulta_request);	
				$last_id_request=mysqli_insert_id($conexion);

				$consulta_railroad_civil="INSERT INTO railroad_request_civil_plans(service_number,id_request  ,task_request_railroad_civil,date_task_request_railroad_civil,expected_return_railroad_civil,crossing_proposed_railroad_civil,from_railroad_civil,to_railroad_civil,scope_work_railroad_civil, engineering_stamped_railroad_civil) VALUES('".mysqli_real_escape_string($conexion,htmlspecialchars($_POST['service_number']))."','".$last_id_request."','".$task_request_number_railroad_plans_civil."','".$date_task_requested_railroad_plans_civil."','".$expected_return_date_railroad_plans_civil."','".$railroad_plans_radio_civil."','".$from_railroad_civil."','".$to_railroad_civil."','".$textarea_scope_railroad_civil."','".$_POST['engineering_stamped_railroad_civil']."' ) ";
