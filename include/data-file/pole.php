	...
	///////////////////////////////////////////////////////////////////////////////////////		
		...
		// OUTSIDE UTILITY POLE PLAN	
			if($_POST['si_outside_utility_task']=="si"){
				$consulta_request="INSERT INTO request (id_request,tipo,fecha,estado, contratista_id, usuario_id) VALUES('".$_SESSION['time_code']."','outside_utility_task','".$fecha."','1','2','".$_SESSION['id']."') ";
				
				$resultado_request= mysqli_query($conexion,$consulta_request);	
				$last_id_request=mysqli_insert_id($conexion);

				$consulta_outsite_utility_pole_plan_task="INSERT INTO outsite_utility_pole_plan_task(service_number,id_request,outsite_utility_company,outsite_utility_contact,outsite_underground_application,outsite_application_company,outsite_applicacion_contact,outsite_cust_cable,outsite_cust_tie_net,outsite_text_here,outsite_aerial_application) VALUES('".mysqli_real_escape_string($conexion,htmlspecialchars($_POST['service_number']))."','".$last_id_request."','".$company_outside_pole."','".$contact_outside_pole."','".$underground_application."','".$company_application_needed."','".$contact_application_needed."','".$cust_cable_count."','".$cust_loc_net."','".$textarea_under_pole."','".$_POST['aerial_application']."')";	
		...
		// highway_traffic_POLE_PLAN	
			if($_POST['si_hightway_traffic_pole']=="si"){

				$consulta_request="INSERT INTO request (id_request,tipo,fecha,estado, contratista_id, usuario_id) VALUES('".$_SESSION['time_code']."','hightway_traffic_pole','".$fecha."','1','2','".$_SESSION['id']."') ";
				
				$resultado_request= mysqli_query($conexion,$consulta_request);	
				$last_id_request=mysqli_insert_id($conexion);

				 $consulta_highway_traffic_pole_plan="INSERT INTO highway_traffic_pole_plan(service_number,id_request ,other_highway_task_request_number,other_highway_date_task,other_highway_expected_date,other_highway_proposed_tmp,other_highway_traffic,other_highway_engineering_plans_pole,other_highway_from,other_highway_to,other_highway_scope) VALUES('".mysqli_real_escape_string($conexion,htmlspecialchars($_POST['service_number']))."','".$last_id_request."','".$task_request_number_pole."','".$date_task_requested_pole."','".$expected_return_date_pole."','".$proposed_tmp_length_pole."','".$highway_proposed_pole."','".$task_engineering_plans_pole."','".$from_proposed_pole."','".$to_proposed_pole."','".$scope_work_proposed_pole."')";		
		...
		// railroad_crossing_pole_plans	
			if($_POST['si_railroad_pole']=="si"){	
					$consulta_request="INSERT INTO request (id_request,tipo,fecha,estado, contratista_id, usuario_id) VALUES('".$_SESSION['time_code']."','railroad_crossing_pole_plans','".$fecha."','1','2','".$_SESSION['id']."') ";
					
					$resultado_request= mysqli_query($conexion,$consulta_request);	
					$last_id_request=mysqli_insert_id($conexion);	

				 	$consulta_railroad_crossing_pole_plans="INSERT INTO railroad_crossing_pole_plans(service_number,id_request  ,other_railroad_task_request_number,other_railroad_date_task,other_railroad_expected_date,other_railroad_crossing_proposed,other_railroad_from,other_railroad_to,other_railroad_scope, engineering_plans_pole_railroad) VALUES('".mysqli_real_escape_string($conexion,htmlspecialchars($_POST['service_number']))."','".$last_id_request."','".$task_request_number_pole_railroad."','".$date_task_requested_pole_railroad."','".$expected_return_date_pole_railroad."','".$highway_proposed_pole_railroad."','".$from_proposed_pole_railroad."','".$to_proposed_pole_railroad."','".$scope_work_proposed_pole_railroad."','".$engineering_plans_pole_railroad."')";		
