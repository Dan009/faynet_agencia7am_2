				...
				<div class="center_form">
					...
					<div class="container_company" >
						...
						<div class="div_container_company div_container_company_tres" >
							...
							<input type="text" name="contact_name_property" class="input_cable_inside" value="<?php if (!empty($_POST['id_tipo'])){ echo $fila_search['contact_name']; } ?>" <?php if (!empty($_POST['id_tipo'])){ echo "disabled";} ?> />
