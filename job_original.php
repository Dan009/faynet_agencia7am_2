						...
						<ul class="ul_menu">
    						<li id="li_request" >MORE 
								<ul class="ul_desplegable" >
                                    <li class="open_detail_job" id="<?php echo $fila['id_request'].".".$fila['id']; ?>"  name="<?php  echo "ver_request"; ?>" title="<?php echo $fila_principal['tipo']; ?>">View Request</li>

                                    <?php if ($_SESSION['estado'] == 3) {  ?>
                                    	<li class="open_designer" id="<?php echo $fila['id_request']; ?>"  name="<?php echo $fila['tipo']; ?>">Designer</li> 
