<?php 
	...
	if(!isset($_SESSION['admin'])){	
		...
		if($_SESSION['estado']==3){	
			...
			$consulta="SELECT * FROM request WHERE contratista_id='".$_SESSION['company']."' AND estado='1' AND estatus_job='0' ";

		}else{
			//MUESTRA LOS REQUEST PARA EL CLIENTE	
			$consulta="SELECT * FROM request WHERE usuario_id='".$_SESSION['id']."' AND estado='1' AND estatus_job='0'  ";	
		...
		<div class="center_form">
			...
			<div class="container_active_jobs">
				...
				<div class="container_text_active_jobs open_detail_job" id="<?php echo $fila['id']; ?>"  name="<?php if($_SESSION['estado'] ==3 ){ echo "ver_request";}else{echo "ver_cotizacion"; } ?>"  >
					...
					?>
					<div class="content_active_jobs" > <div><?php echo $fila_company['nombref']; ?>  </div> </div>
					
					<div class="content_active_jobs" > 
						<div>
						<!--    -->
							<div class="view_detail_job" > View </div> 
