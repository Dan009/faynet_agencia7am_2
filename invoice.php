...
<body>
<div id="type_plan">POLE PLAN</div>
<div class="container-general-info">
  ...
  <div class="campos-container">
  	<div class="header-info"><strong>GENERAL INFO</strong></div>
        ...
        <div class="description" style="height:75px; border:1px solid #000; margin-top:10px;">Mark Bonanno</div>
...
<div class="container-isp">
  ...
  <div style="float:left; width:100%;">
        <div class="name"><strong>EXISTING BUILDING.</strong></div>
  ...
  <div style="overflow:hidden; border-top:1px solid #000; padding-left:5px;">
    ...
    <div style="font-size:12px;"><strong>Assigned Company:</strong> company <strong>Contact:</strong> Jairo Cuesta</div>
  </div>
  </div>
...
<div class="sub-name" style="font-size:13px;"><strong>SP ENG. PLANS ONLY (NO SURVEY)</strong></div>
  ...
  <div style="overflow:hidden; padding-left:5px;">
    ...
    <div style="font-size:12px;"><strong>Assigned Company:</strong> company  </div>
  </div>
  </div>
  <div style="width:100%; float:left; border-top:2px solid #000;"></div>
...
<div class="container_archive_inside div_file_inside"><strong>ENGINERING PLAN QUOTE</strong><br /><br />
    <input type="text" placeholder="5000" /> </div>
